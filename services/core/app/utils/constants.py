...
ERR_STORY_EDIT_FORBIDDEN = "Only the reporter, assignee, or project owner can edit this story"
...
ERR_STORY_NOT_FOUND = "Story not found"
ERR_TASK_DONE_FORBIDDEN = "Only the assignee, reporter, or Owner can toggle completion"
